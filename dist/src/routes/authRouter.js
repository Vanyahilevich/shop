...
router.get("/auth", authRouter, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    console.log("auth");
...
router.get("/logout", authRouter, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        return res.redirect('/');
    }
